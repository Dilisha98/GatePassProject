...
const [uploadedFileName, setUploadedFileName] = useState(null);
 ...
 const handleUpload = (event) => {
  ...
  const fadeStyles = {
    ...
    exiting: { opacity: 0 },
    exited: { opacity: 0, transition: 'opacity 0ms ease-in-out' },
  };
    ...
    {/*------------------- This is a Sender Details form-------------------*/}
      ...
      <Container className='LocationContain'>
        ...
        <form action="#" className='ml-2'>
          <div className="user-details">
            <div className="Reciver_available_colomun">
              <div className="">
                <span className="Reciver_Available_Title">If Receiver Available</span>
              </div>
        ...
        {(state) => (
          <div className='form-container' style={{ ...fadeStyles[state] }}>
            <Container className='Contain'>
              <div className='title'>Receiver Details</div>
              <form action="#">
                <div className="user-details">
                  <div className="input-div">
                    <div>
