...
import My_Request from './pages/My_Request/My_Request';
...
import MyRequestDeatils from './pages/My_Request/My_RequestDeatils';
          ...
          <Router>
            <Routes>
              ...
              <Route path="/ApprovedItemDetails" element={<ApprovedItemDetailsWithNavbar />}/>
                ...
                <Route path="/My_RequestDeatils" element={<MyRequestDeatilsWithNavbar />} />
...
function MyRequestDeatilsWithNavbar() {
  const currentPath = window.location.pathname;
  if (currentPath === '/My_RequestDeatils') {
    return (
      <>
        <NavbarComp />
        <MyRequestDeatils />
